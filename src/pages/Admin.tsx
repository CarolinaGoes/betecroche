...
export default function Admin() {
  ...
  const [categories, setCategories] = useState<string[]>(["Mesa", "Banho", "Cozinha", "Decoração"]);
    ...
    <div className="min-h-screen bg-[#FDF7FF] p-4 md:p-8 font-sans text-gray-800">
      <div className="max-w-4xl mx-auto">
        ...
        <header className="mb-8 text-center text-purple-600">
          ...
          <p className="text-gray-500 mt-1 font-medium">Gerencie suas obras de arte em crochê</p>
        </header>
        ...
        <section className="bg-white rounded-4xl shadow-lg p-6 md:p-8 mb-8 border-4 border-white">
          ...
          <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-bold text-purple-700 ml-2 mb-2 uppercase tracking-wide">Preço de Venda (R$)</label>
            ...
            <div className="bg-purple-100/50 p-6 rounded-2xl border-2 border-dashed border-purple-300 text-center">
              <label className="cursor-pointer">
                ...
                <span className="text-purple-700 font-bold block text-lg">{fileName ? `Foto: ${fileName}` : "Selecionar Foto do Crochê"}</span>
              </label>
            </div>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-purple-900 font-serif ml-2 mb-6">Suas Peças Postadas:</h2>
          {items.map(item => (
